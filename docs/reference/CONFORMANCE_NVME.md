...
| 0x08 | Write Zeroes | 🟩 Yes | O | Lowered to `PageCache::write_bytes(..., &vec![0; nlb * lba_bytes])`. Sub-page zeroing via cache RMW. WORM refuses with `Namespace Is Write Protected` (Generic 0x20). |
