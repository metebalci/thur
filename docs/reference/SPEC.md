...
| 0x8F | VERIFY(16) | |
| 0x91 | SPACE(16) | 64-bit signed count; same filemark-halt (issue #102), residual, and direction-aware EOD-vs-BOP termination as SPACE(6). |
