...
| Page | Name | Status | Spec | Notes |
|-----:|------|--------|:----:|-------|
| 0x00 | Supported VPD Pages | 🟩 Yes | CC | Lists `[0x00, 0x80, 0x83, 0xB0, 0xB2]` for registered LUNs; `[0x00]` for the "no LUN" reply. |
| 0x80 | Unit Serial Number | 🟩 Yes | O | Hex-encoded volume UUID. |
| 0x83 | Device Identification | 🟩 Yes | M | One T10 vendor-based descriptor: 8-byte vendor ID `MB` + ASCII `MBD_<uuid_hex>`. |
