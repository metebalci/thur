...
| `test-legal-hold-lifecycle.sh` | Storage-native legal hold end-to-end: set/clear/status + the migrate gate refusing a held cartridge (Object-Lock backend, `THURVTL_TEST_BACKEND`). |
