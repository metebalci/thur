...
#
# Same shape as test-fs-storage.sh, but the moving part is the keystore
...
# test-fs-storage.sh / test-pipeline-layers.sh row 3. This script is
...
# Same convention as test-fs-storage.sh: anything KEY=VAL in thur.env
