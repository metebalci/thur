...
# as test-fs-storage.sh: pick a backend by name from a source
...
# conventions as test-fs-storage.sh.
#
...
# version contract as test-fs-storage.sh.
...
# matching test-fs-storage.sh's full Phase C is overkill for the
# matrix.
row_baseline() {
